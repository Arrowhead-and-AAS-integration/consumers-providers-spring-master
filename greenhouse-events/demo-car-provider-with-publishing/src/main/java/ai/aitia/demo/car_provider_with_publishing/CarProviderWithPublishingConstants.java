...
public class CarProviderWithPublishingConstants {
	...
	public static final String CREATE_CAR_SERVICE_DEFINITION = "create-humidity";
	public static final String GET_CAR_SERVICE_DEFINITION = "get-humidity";
	public static final String INTERFACE_SECURE = "HTTP-SECURE-JSON";
	public static final String INTERFACE_INSECURE = "HTTP-INSECURE-JSON";
	public static final String HTTP_METHOD = "http-method";
	public static final String CAR_URI = "/humidity";
